    ...
    <form class="md-float-material" method="POST" action="{{ route('signup-user') }}">
        ...
        <div class="auth-box">
            ...
            <p style="display: none;" class="text-right text-inverse" id="countdown"><span
                    class="text-danger f-w-600">60</span> seconds remaining for Send OTP again.</p>
            <div class="input-group">
                <input type="text" class="form-control" id="otp" name="otp" placeholder="Enter Verification Code"
                    required>
                <span class="md-line"></span>
            </div>
            <div class="input-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="text-left">
                        <a href="{{ route('login') }}" class="text-right f-w-600 text-primary">Already have an
                            account?</a>
                    </p>
                </div>
            </div>
