...
<head>
    <meta charset="utf-8">
    <title>Landing Page - Guru able Bootstrap4 admin template</title>
    <!-- Meta -->
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ asset('home_assets/logos/favicon.ico') }}" type="image/png"
        sizes="16x16">
    <!-- Bootstrap -->
    <link href="{{ asset('home_assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <!-- Font -->
    ...
    <!-- Main Style css -->
    <link href="{{ asset('home_assets/css/style.css') }}" rel="stylesheet" type="text/css"
        media="all" />
</head>
    ...
    <div class="wrapper animsition" data-animsition-in-class="fade-in" data-animsition-in-duration="1000"
                ...
                <div class="container">
                    ...
                    <div class="navbar-header page-scroll">
                        ...
                        <a class="navbar-brand page-scroll" href="#main"><img
                                src="{{ asset('home_assets/logos/logo.png') }}"
                                alt="Guru Able Logo" /></a>
                    </div>
        ...
        <div class="main" id="main">
                        ...
                        <div class="col-md-12">
                            <div class="hero-image">
                                <img class="img-responsive"
                                    src="{{ asset('home_assets/images/app_hero_1.png') }}"
                                    alt="" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="services">
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="services-icon">
                                    <img src="{{ asset('home_assets/logos/icon1.png') }}"
                            ...
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="services-icon">
                                    <img class="icon-2"
                                        src="{{ asset('home_assets/logos/icon2.png') }}"
                                        height="60" width="60" alt="Service" />
                                </div>
                                <div class="services-description">
                            ...
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                                <div class="services-icon">
                                    <img class="icon-3"
                                        src="{{ asset('home_assets/logos/icon3.png') }}"
                                        height="60" width="60" alt="Service" />
                                </div>
                                <div class="services-description">
                    ...
                    <div class="flex-split">
                        ...
                        <div class="f-left wow fadeInUp" data-wow-delay="0s">
                            <div class="left-content">
                                <img class="img-responsive"
                                    src="{{ asset('home_assets/images/feature_1.png') }}"
                                    alt="" />
                            </div>
                        </div>
                    ...
                    <div class="flex-split">
                        ...
                        <div class="f-left">
                            <div class="left-content wow fadeInUp" data-wow-delay="0.3s">
                                <img class="img-responsive"
                                    src="{{ asset('home_assets/images/feature_2.png') }}"
                                    alt="" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="testimonials owl-carousel owl-theme">
                                <div class="testimonial-single"><img class="img-circle"
                                        src="{{ asset('home_assets/images/testimonial2.jpg') }}"
                                ...
                                <div class="testimonial-single"><img class="img-circle"
                                        src="{{ asset('home_assets/images/testimonial1.jpg') }}"
                                        alt="Client Testimonoal" />
                                ...
                                <div class="testimonial-single"><img class="img-circle"
                                        src="{{ asset('home_assets/images/testimonial3.jpg') }}"
                                        alt="Client Testimonoal" />
                                    <div class="testimonial-text">
                                        <p>5 stars are for the excellent support, that is brilliant! The design is very
                                            cool and the quality of code is excellent. <br
                                                class="hidden-xs">Compliments!</p>
                                        <h3>Code Quality</h3>
                ...
                <div class="container nopadding">
                    <div class="col-md-12">
                        <img class="img-responsive wow fadeInUp" data-wow-delay="0.1s"
                            src="{{ asset('home_assets/images/big_feature.png') }}" alt=""
                            style="max-width:100%" />
                    </div>
                    <div class="feature_list">
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                            <img src="{{ asset('home_assets/logos/feature_icon.png') }}"
                                alt="Feature" />
                        ...
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                            <img src="{{ asset('home_assets/logos/feature_icon_2.png') }}"
                                alt="Feature" />
                        ...
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
                            <img src="{{ asset('home_assets/logos/feature_icon_3.png') }}"
                                alt="Feature" />
                    ...
                    <div class="col-md-12 col-sm-12 nopadding">
                        ...
                        <div class="col-sm-6 nopadding">
                            <div class="table-left wow fadeInUp" data-wow-delay="0.4s">
                                <div class="icon">
                                    <img src="{{ asset('home_assets/logos/cart2.png') }}"
                                        alt="Icon" />
                                </div>
                        ...
                        <div class="col-sm-6 nopadding">
                            <div class="table-right wow fadeInUp" data-wow-delay="0.6s">
                                <div class="icon">
                                    <img src="{{ asset('home_assets/logos/cart1.png') }}"
                                        alt="Icon" />
                                </div>
                                <div class="pricing-details">
                                    <h2>Premium Plan</h2>
            ...
            <div class="footer">
                <div class="container">
                    <div class="col-md-12 text-center">
                        <img src="{{ asset('home_assets/logos/logo.png') }}"
                            alt="Guru Able Logo" />
