                        ...
                        <div class="col-md-12">
                            <div id="wizard">
                                <section>
                                    <div class="wizard-form" id="registrationForm" action="#">
                                        ...
                                        <section>
                                            <form action="" id="applicationDataForm">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h4 class="sub-title">{{ __('application.personal_heading') }}
                                                        </h4>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label for="firstName"
                                                                    class="block">{{ __('application.first_name') }}</label>
                                                            </div>
                                                            <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label for="otherNames"
                                                                    class="block">{{ __('application.other_names') }}</label>
                                                            </div>
                                                            <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label for="surname"
                                                                    class="block">{{ __('application.surname') }}</label>
                                                            </div>
                                                            <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label for="gender"
                                                                    class="block">{{ __('application.gender') }}</label>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <select id="gender" name="gender" class="form-control">
                                                                    <option value="male" {{ $applicationData->gender ==
                                                                        'male' ? 'selected' : '' }}>Male
                                                                    </option>
                                                                    <option value="female" {{ $applicationData->gender
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label for="dateOfBirth"
                                                                    class="block">{{ __('application.dob') }}</label>
                                                            </div>
                                                            <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select id="maritalStatus" name="maritalStatus"
                                                                    class="form-control">
                                                                    <option value="single" {{ $applicationData->
                                                                        marital_status == 'single' ? 'selected' : ''
                                                                        }}>Single</option>
                                                                    <option value="married" {{ $applicationData->
                                                                        marital_status == 'married' ? 'selected' : ''
                                                                        }}>Married</option>
                                                                    <option value="divorced" {{ $applicationData->
                                                                        marital_status == 'divorced' ? 'selected' : ''
                                                                        }}>Divorced</option>
                                                                    <option value="widowed" {{ $applicationData->
                                                                        marital_status == 'widowed' ? 'selected' : ''
                                                                        }}>Widowed</option>
                                                                </select>
                                      ...
                                      <label>
                                        ...
                                        <i class="helper"></i>Widowed
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea id="socialMediaHandles" rows="5"
                                                                    name="socialMediaHandles"
                                                                    class="form-control">{{ $applicationData->social_media_handles }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h4 class="mt-5 sub-title">
                                                            {{ __('application.employment_heading') }}</h4>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label for="companyName"
                                                                    class="block">{{ __('application.company_name') }}</label>
                                                            </div>
                                                            <div class="col-sm-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input id="monthlyNetIncome" name="monthlyNetIncome"
                                                                    type="text" class="form-control"
                                                                    value="{{ $applicationData->monthly_net_income }}" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select id="outstandingLoan" name="outstandingLoan"
                                                                    class="form-control">
                                                                    <option value="no" {{ $applicationData->
                                                                        outstanding_loan == 'no' ? 'selected' : '' }}>No
                                                                    </option>
                                                                    <option value="yes" {{ $applicationData->
                                                                        outstanding_loan == 'yes' ? 'selected' : ''
                                                                        }}>Yes</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h4 class="mt-5 sub-title">
                                                            {{ __('application.emergency_heading') }}</h4>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input id="emergencyContactRelation"
                                                                    ...
                                                                    class="form-control"
                                                                    value="{{ $applicationData->emergency_contact_relation }}" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input id="emergencyContactNumber"
                                                                    name="emergencyContactNumber" type="text"
                                                                    class="form-control"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input id="emergencyContactLocation"
                                                                    name="emergencyContactLocation" type="text"
                                                                    class="form-control"
                                                                    value="{{ $applicationData->emergency_contact_location }}" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        {{-- <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input id="currentAccommodationStatus"
                                                                    name="currentAccommodationStatus" type="text"
                                                                    class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input id="propertyLocation" name="propertyLocation" type="text"
                                                            class="form-control"
                                                            value="{{ $accomodationData->property_location }}" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select id="propertyType" name="propertyType"
                                                            class="form-control">
                                                            <option value="1-Bedroom" {{ $accomodationData->property_type == '1-Bedroom' ? 'selected' : '' }}>1-Bedroom</option>
                                                            <option value="Chamber and Hall" {{ $accomodationData->property_type == 'Chamber and Hall' ? 'selected' : '' }}>Chamber and Hall</option>
                                                            <option value="2-Bedroom" {{ $accomodationData->property_type == '2-Bedroom' ? 'selected' : '' }}>2-Bedroom</option>
                                                            <option value="3-Bedroom" {{ $accomodationData->property_type == '3-Bedroom' ? 'selected' : '' }}>3-Bedroom</option>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <label for="monthlyRent"
                                                            class="block">{{ __('application.monthly_rent') }}</label>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <input id="monthlyRent" name="monthlyRent" type="text"
                                                            class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <label for="totalRentYears"
                                                    class="block">{{ __('application.rent_years') }}</label>
                                            </div>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input id="totalPaybackMonths" name="totalPaybackMonths" type="text"
                                                    class="form-control"
                                                    value="{{ $accomodationData->total_payback_months }}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                            ...
                            <section>
                                ...
                                <div class="alert alert-danger icons-alert">
                                    <strong>NOTE:</strong> Pay registration fees, then upload your required documents
                                    documents.
                                </div>
                                <div class="text-center">
                                    @if (Auth::user()->user_type != 'TENANT')
                                    <form id="offlinePaymentForm" action="{{ route('application-offlinePayment') }}"
                                        method="POST" accept-charset="UTF-8" style="display: inline-block">
                                        @csrf
                                        <div class="form-group">
                                            <input type="hidden" name="userDataId" value="{{ md5($userDataId) }}">
                                            <button class="btn btn-round d-block mx-auto btn-inverse text-center"
                                                type="submit" onclick="showLoader()">ACCEPT OFFLINE</button>
                                        </div>
                                    </form>
                                    @endif
                                    <form id="paymentForm" action="{{ route('application-payment') }}" method="POST"
                                        accept-charset="UTF-8" style="display: inline-block">
                                        @csrf
                                        <div class="form-group">
                                            <input type="hidden" name="userDataId" value="{{ md5($userDataId) }}">
                                            <button class="btn btn-round d-block mx-auto btn-inverse text-center"
                                                type="submit">PAY REGISTRATION FEES</button>
                                        </div>
                                    </form>
                                </div>
                                @else
                                <form id="documentDataForm">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <label for="passportPictureFile"
                                                        class="block">{{ __('application.upload_profile_picture') }}</label>
                                                </div>
                                                <div class="col-sm-12">
                                                    <input id="passportPictureFile" name="passportPictureFile"
                                                        type="file" class="form-control display-file"
                                                        accept="image/jpg,image/jpeg,image/png,application/pdf"
                                                        style="display: none" />
                                                    <label for="passportPictureFile" id="passportPictureFilePreview"
                                                        class="preview-container">
                                                        @if($documentData->passport_picture_path != NULL)
                                                        <img src="{{ url($documentData->passport_picture_path) }}"
                                                            class="img-fluid" alt=""><br>
                                                        <a href="{{ url($documentData->passport_picture_path) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input id="ghanaCardFile" name="ghanaCardFile" type="file"
                                                        class="form-control display-file"
                                                        accept="image/jpg,image/jpeg,image/png,application/pdf"
                                                        style="display: none" />
                                                    <label for="ghanaCardFile" id="ghanaCardFilePreview"
                                                        class="preview-container">
                                                        @if($documentData->ghana_card_path != NULL)
                                                        <img src="{{ url($documentData->ghana_card_path) }}"
                                                            class="img-fluid" alt=""><br>
                                                        <a href="{{ url($documentData->ghana_card_path) }}"
                                                            target="_blank">Click Here</a>
                                                        @else
                                                        <div class="text-center upload-btn" style="padding: 70px 0;">
                                                            <span class="btn btn-inverse">UPLOAD</span>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <label for="ghanaCard"
                                                        class="block">{{ __('application.ghana_card') }}</label>
                                                </div>
                                                <div class="col-sm-12">
                                                    <input id="ghanaCard" name="ghanaCard" type="text"
                                                        class="form-control" value="{{ $documentData->ghana_card }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input id="bankStatementFile" name="bankStatementFile" type="file"
                                                        ...
                                                        accept="image/jpg,image/jpeg,image/png,application/pdf"
                                                        style="display: none" />
                                                    <label for="bankStatementFile" id="bankStatementFilePreview"
                                                        class="preview-container">
                                                        @if($documentData->statement_path != NULL)
                                                        <img src="{{ url($documentData->statement_path) }}"
                                                            class="img-fluid" alt=""><br>
                                                        <a href="{{ url($documentData->statement_path) }}"
                                                            target="_blank">Click Here</a>
                                                        @else
                                                        <div class="text-center upload-btn" style="padding: 70px 0;">
                                                            <span class="btn btn-inverse">UPLOAD</span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input id="employmentLetterFile" name="employmentLetterFile"
                                                        type="file" class="form-control display-file"
                                                        accept="image/jpg,image/jpeg,image/png,application/pdf"
                                                        style="display: none" />
                                                    <label for="employmentLetterFile" id="employmentLetterFilePreview"
                                                        class="preview-container">
                                                        @if($documentData->employment_letter_path != NULL)
                                                        <img src="{{ url($documentData->employment_letter_path) }}"
                                                            class="img-fluid" alt=""><br>
                                                        <a href="{{ url($documentData->employment_letter_path) }}"
                                                            target="_blank">Click Here</a>
                                                        @else
                                                        <div class="text-center upload-btn" style="padding: 70px 0;">
                                                            <span class="btn btn-inverse">UPLOAD</span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input id="landlordEmail" name="landlordEmail" type="text"
                                                        class="form-control"
